...
//		-- Test this code by hardcoding the situation where there is no camera or photo library
//		-- You should also test the situation where the device has a camera and photo library, but
//			the app doesn't have access to it. Do this by deleting the app from the device or
//			resetting the simulator. Run the app and answer "no" when iOS asks if MyStuff can
//			access your camera or photo library. See what happens.
...
//		let hasCamera = UIImagePickerController.isSourceTypeAvailable(.Camera)
		...
		switch (hasPhotos,hasCamera) {
			...
			default: /* (false,false) */
				var message = "MyStuff cannot access a camera or your photo library."
				let alert = UIAlertController(title: "No Picture Source",
											message: message,
									 preferredStyle: .Alert )
				let okAction = UIAlertAction(title: "I'm Sorry", style: .Default, handler: nil)
